    ...
    return {
    	...
    	onRequest: function( context ) {
			...
			var form = serverWidget.createForm(
				{
					title: 'Interactive SuiteQL Query Tool',
					hideNavBar: false
				}
			);		
 ...
 *
 * @param context
 * @param context.request.parameters.custpage_field_action
 * @param form
 */
 ...
 *
 * @param context
 * @param context.request.parameters.custpage_field_fileid
 * @param form
 */
 ...
 * @param context.request.parameters
 * @param context.request.parameters.custpage_field_filename
 * @param context.request.parameters.custpage_field_query
 * @param form
 */
